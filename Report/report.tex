...
\begin{center}
    ...
    \begin{tabular}{| c | c | c | c | c |}
        ...
        \hline\hline
        \makecell{STM32 \\ Microcontroller} & \makecell{Provides \\ electrical \\ signals} & STM32 & \makecell{Functions as the "hub" of \\ all electricity in the project. \\ Can deliver what we need on command.} & 1 \\
        \hline
        \makecell{Single Board \\ Computer \\ (SBC)} & \makecell{Provides \\ Computational \\ Power} & Raspberry Pi 5 & \makecell{Functions as the "hub" of \\ all complex computation \\ and mathematics \\ in the project} & 1 \\
        \hline
        Servo & Rotation & DS3218MG & Provides movement control & 4 \\
        \hline
...
\section{Robot arm sketch}
Witness the true artistry of Johannes Standal (Painted by hand (trackpad) using MS Paint)

\section{Project links}
\href{https://github.com/JohannesStandal/Eik---Project-Louis}{Github}
